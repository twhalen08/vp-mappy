...
builder.Services.Configure<OverlayAuthOptions>(builder.Configuration.GetSection("OverlayAuth"));
builder.Services.AddSingleton<IOverlayTokenService, OverlayTokenService>();
